class TVMDemo {
  ...
  wasmInstance = null;
  constructor() {
    this.statusEl = document.getElementById('tvm-status');
    this.logEl = document.getElementById('tvm-output-log');
    this.compileBtn = document.getElementById('tvm-compile-btn');
    this.runBtn = document.getElementById('tvm-run-btn');
    this.inputEl = document.getElementById('tvm-input-model');
  ...
  async run() {
    ...
    const addFn = this.wasmInstance.exports.add;
