...
class GenAIDemo {
  ...
  constructor() {
    this.statusEl = document.getElementById('genai-status') as HTMLElement;
    this.outputEl = document.getElementById('genai-output') as HTMLElement;
    this.inputEl = document.getElementById('genai-input') as HTMLInputElement;
    this.btnEl = document.getElementById('genai-btn') as HTMLButtonElement;
