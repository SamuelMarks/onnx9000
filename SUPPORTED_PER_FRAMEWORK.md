...
- [**ONNX Standard** (`160/200` supported)](compliance/ONNX_SUPPORT.md)
- [**Torch** (`25/935` supported)](compliance/TORCH_SUPPORT.md)
- [**Tensorflow** (`177/352` supported)](compliance/TENSORFLOW_SUPPORT.md)
- [**Keras** (`47/714` supported)](compliance/KERAS_SUPPORT.md)
- [**Jax** (`1/1767` supported)](compliance/JAX_SUPPORT.md)
- [**Flax** (`1/1929` supported)](compliance/FLAX_SUPPORT.md)
...
- [**Gguf** (`2/381` supported)](compliance/GGUF_SUPPORT.md)
