...
| **Interactive Sphinx Demos**<br>[Tasks](./specs/ONNX45_DEMO_IN_SPHINX.md)                                                               | In-browser model conversion demonstrations using Vanilla JS and WASM.                | 251/289         | ⏳ In Progress |
| **Extended Sphinx Demos**<br>[Tasks](./specs/ONNX45_DEMO_EXTENDED_IN_SPHINX.md)                                                         | Multi-step pipelines including optimization, quantization, and MLIR lowering.        | 244/279         | ⏳ In Progress |
