...
def test_bitwise_opsets(temp_dir: Path):
    ...
    def bitwise_model(a, b, c):
        """bitwise_model docstring."""
        ba = onnx9000.ops.bitwise_and(a, b)
        bn = onnx9000.ops.bitwise_not(a)
        bo = onnx9000.ops.bitwise_or(a, b)
        bx = onnx9000.ops.bitwise_xor(a, b)
        bsl = onnx9000.ops.bitshift(c, c, "LEFT")
        bsr = onnx9000.ops.bitshift(c, c, "RIGHT")
