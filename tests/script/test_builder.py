...
def test_graph_builder_basic():
    ...
    v1 = builder.add_input("x", DType.FLOAT32, (1, 3, 224, 224))
    v2 = builder.add_input("y", DType.FLOAT32, (1, 3, 224, 224))
...
def test_graph_builder_initializer():
...
def test_graph_builder_metadata():
    builder = GraphBuilder()
...
def test_graph_builder_to_onnx():
    builder = GraphBuilder()
...
def test_graph_builder_from_onnx():
    builder = GraphBuilder()
    builder.add_input("x", DType.FLOAT32, (1, 10))
    node = Node(
        op_type="Relu",
...
def test_graph_builder_validate():
    builder = GraphBuilder()
...
def test_graph_builder_edit_apis():
    builder = GraphBuilder()
    node1 = Node(op_type="Relu", inputs=["a"], outputs=["b"], attributes={})
...
def test_graph_builder_merge_and_rename():
    b1 = GraphBuilder("G1")
...
def test_graph_builder_all_attributes():
    builder = GraphBuilder()
    attrs = {
        "a_float": 1.5,
        "an_int": 42,
...
def test_graph_builder_extract_subgraph():
    builder = GraphBuilder()
