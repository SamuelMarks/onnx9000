...
def test_jax_importer_add_mul_i32():
    ...
    from onnx9000.frontends.jax.importer import JaxprImporter, _map_jax_type
...
def test_jax_importer_extra():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.jax.importer import JaxprImporter
...
def test_jax_importer_constvars_and_load():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.jax.importer import JaxprImporter, load
    ...
    with patch("onnx9000.core.parser.load", return_value="onnx_loaded"):
