...
def test_paddle_parsers_var_desc_dims_and_skips():
    name = b"\n\x01X"
    ...
    tensor_msg = (
        b"\x08\x02" + dim_unpacked + dim_packed + skip_wire1 + skip_wire2 + skip_wire5
    )
...
def test_paddle_parsers_skip_field_error():
    bad_wire = b"\n\x01X\xfb\x06\x01"
