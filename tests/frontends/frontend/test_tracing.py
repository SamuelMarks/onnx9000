...
def test_tracing_dtypes():
    ...
    with onnx9000.Tracing(builder):
        onnx9000.core.ops.add(t1, np.array([1], dtype=np.int32))
        onnx9000.core.ops.add(t1, np.array([1.0], dtype=np.float64))
        onnx9000.core.ops.add(t1, np.array([True], dtype=bool))
