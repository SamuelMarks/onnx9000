...
import pytest
import numpy as np
from onnx9000.frontends.frontend.utils import (
...
def test_record_op_no_context():
    """Provides semantic functionality and verification."""
    with pytest.raises(RuntimeError):
        record_op("Add", [Tensor()])


def test_record_op_numpy_constant():
    """Provides semantic functionality and verification."""
...
def test_record_op_special_ops():
    """Provides semantic functionality and verification."""
    gb = GraphBuilder("test")
    with Tracing(gb):
...
def test_tensor_init_bad_data():
    ...
    class Bad:
        ...
        def __array__(self):
            """Provides   array   functionality and verification."""
...
def test_tensor_item_tolist_numpy():
    """Provides semantic functionality and verification."""
...
def test_record_op_transpose_missing():
    """Provides semantic functionality and verification."""
    gb = GraphBuilder("test")
    with Tracing(gb):
...
def test_tensor_transpose_prop():
    """Provides semantic functionality and verification."""
    gb = GraphBuilder("test")
    with Tracing(gb):
        t1 = Tensor((10,), DType.FLOAT32)
...
def test_infer_elementwise_dynamic():
    """Provides semantic functionality and verification."""
    assert infer_elementwise_shape(("batch",), (1,)) == ("batch",)
    assert infer_elementwise_shape((1,), ("batch",)) == ("batch",)
...
def test_infer_elementwise_dynamic_missing():
    """Provides semantic functionality and verification."""
    assert infer_elementwise_shape((1,), ("batch",)) == ("batch",)
    assert infer_elementwise_shape(("batch",), (2,)) == ("batch",)


def test_tensor_r_ops():
    """Provides semantic functionality and verification."""
...
def test_tracer_exceptions_and_args():
    """Provides semantic functionality and verification."""
...
def test_tracer_returns():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.frontend.tracer import trace

    def my_fn_tup(a):
        """Provides my fn tup functionality and verification."""
        return (a,)

    def my_fn_list(a):
        """Provides my fn list functionality and verification."""
        return [a]

    def my_fn_dict(a):
        """Provides my fn dict functionality and verification."""
        return {"a": a}
...
def test_tracer_proxy_kwargs_else():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.frontend.tracer import trace
...
def test_tracer_proxy_kwargs_if():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.frontend.tracer import trace
