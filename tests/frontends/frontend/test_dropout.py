...
from onnx9000.frontends.frontend.nn.dropout import Dropout, Dropout2d
...
def test_dropout_single_res():
    """Provides semantic functionality and verification."""
    from onnx9000.frontends.frontend.nn.dropout import Dropout
    from unittest.mock import patch

    d = Dropout()
    with patch(
        "onnx9000.frontends.frontend.utils.record_op", return_value="fake_tensor"
    ):
