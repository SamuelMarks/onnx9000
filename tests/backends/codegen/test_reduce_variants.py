...
def test_reduce_variants(temp_dir: Path):
    ...
    @onnx9000.jit
    def rv_model(x):
        """Provides rv model functionality and verification."""
        ss = onnx9000.core.ops.reduce_sum_square(x)
        l1 = onnx9000.core.ops.reduce_l1(x)
        l2 = onnx9000.core.ops.reduce_l2(x)
        ls = onnx9000.core.ops.reduce_log_sum(x)
        lse = onnx9000.core.ops.reduce_log_sum_exp(x)
