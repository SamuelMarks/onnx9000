...
def test_logic_ops(temp_dir: Path):
    ...
    def logic_model(x, y, cond):
        """Provides logic model functionality and verification."""
        e = onnx9000.core.ops.equal(x, y)
        g = onnx9000.core.ops.greater(x, y)
        l = onnx9000.core.ops.less(x, y)
        a = onnx9000.core.ops.and_(cond, cond)
        o = onnx9000.core.ops.or_(cond, cond)
        n = onnx9000.core.ops.not_(cond)
        return e, g, l, a, o, n
