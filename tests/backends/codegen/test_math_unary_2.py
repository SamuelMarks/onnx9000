...
def test_math_unary_2(temp_dir: Path):
    ...
    def math_model(x, y):
        ...
        r = onnx9000.core.ops.round(x)
        f = onnx9000.core.ops.floor(x)
        n = onnx9000.core.ops.neg(x)
        rec = onnx9000.core.ops.reciprocal(x)
        s = onnx9000.core.ops.sign(x)
        is_i = onnx9000.core.ops.isinf(x)
        is_n = onnx9000.core.ops.isnan(x)
        m = onnx9000.core.ops.mod(x, y)
        p = onnx9000.core.ops.pow(x, y)
