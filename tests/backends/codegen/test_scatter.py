...
def test_scatter_elements(temp_dir: Path):
    """Tests the test scatter elements functionality."""

    @onnx9000.jit
    def model(data, indices, updates):
        """Provides model functionality and verification."""
        return onnx9000.core.ops.scatter_elements(data, indices, updates, axis=0)
...
def test_scatter_nd(temp_dir: Path):
    """Tests the test scatter nd functionality."""

    @onnx9000.jit
    def model(data, indices, updates):
        """Provides model functionality and verification."""
        return onnx9000.core.ops.scatter_nd(data, indices, updates)
