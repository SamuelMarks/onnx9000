...
def test_pooling_ops(temp_dir: Path):
    ...
    @onnx9000.jit
    def pool_model(x):
        """Provides pool model functionality and verification."""
        p1 = onnx9000.core.ops.average_pool(x, kernel_shape=[2, 2], strides=[2, 2])
        p2 = onnx9000.core.ops.max_pool(x, kernel_shape=[2, 2], strides=[2, 2])
        p3 = onnx9000.core.ops.global_average_pool(x)
        p4 = onnx9000.core.ops.global_max_pool(x)
        return p1, p2, p3, p4
