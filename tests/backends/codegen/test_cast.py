...
def test_cast_opsets(temp_dir: Path):
    ...
    @onnx9000.jit
    def cast_model(a):
        """Provides cast model functionality and verification."""
        return onnx9000.core.ops.cast(a, to_type=1)
...
def test_cast_like_opsets(temp_dir: Path):
    ...
    def cast_like_model(a, b):
        """Provides cast like model functionality and verification."""
        return onnx9000.core.ops.cast_like(a, b)
...
def test_cast_saturate(temp_dir: Path):
    ...
    def cast_sat_model(a):
        """Provides cast sat model functionality and verification."""
