...
def test_exceptions():
    """Tests the test exceptions functionality."""
...
def test_cache(temp_dir: Path):
    """Tests the test cache functionality."""
...
def test_cli(temp_dir: Path):
    """Tests the test cli functionality."""
    test_onnx = temp_dir / "test.onnx"
    test_onnx.touch()
    with patch("onnx9000.cli.main.core_compile") as mock_compile:
        with patch.object(
