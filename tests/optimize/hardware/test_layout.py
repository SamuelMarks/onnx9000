...
def test_supports_layout_attribute():
...
def test_inject_transposes_for_layout():
    """Provides semantic functionality and verification."""
    g = create_mock_graph()
...
def test_transpose_cancellation_pass():
    """Provides semantic functionality and verification."""
...
def test_transpose_cancellation_pass_no_match():
    """Provides semantic functionality and verification."""
    g = Graph("mock_transpose")
    t_node1 = Node("Transpose", ["in"], ["temp"], {"perm": [0, 2, 3, 1]})
...
def test_align_tensor_shapes_pass():
    """Provides semantic functionality and verification."""
    g = create_mock_graph()
...
def test_update_parameters_for_alignment():
    """Provides semantic functionality and verification."""
    node = Node("Conv", [], [], {})
...
def test_chunk_large_tensors_pass():
    """Provides semantic functionality and verification."""
    g = create_mock_graph()
...
def test_push_transposes_down_real():
    """Provides semantic functionality and verification."""
    g = Graph("mock")
    g.inputs = ["in"]
    g.outputs = ["out"]
...
def test_update_parameters_for_alignment_reshape():
    """Provides semantic functionality and verification."""
...
def test_chunk_large_tensors_pass_real():
    """Provides semantic functionality and verification."""
    g = Graph("mock")
...
def test_push_transposes_down_mixed_inputs():
    """Provides semantic functionality and verification."""
    g = Graph("mock")
    g.inputs = ["in1", "in2"]
    g.outputs = ["out"]
...
def test_push_transposes_down_real():
    """Tests the test push transposes down real functionality."""
    g = Graph("mock")
    g.inputs = ["in"]
    g.outputs = ["out"]
    t1 = Node("Transpose", ["in"], ["t_out"], {"perm": [0, 2, 3, 1]}, "t1")
...
def test_update_parameters_for_alignment_reshape():
    """Tests the test update parameters for alignment reshape functionality."""
    n = Node("Reshape", ["in"], ["out"], {"shape": [1, 2, 3]}, "r1")
    n2 = LayoutOptimizer.update_parameters_for_alignment(n, 2)
    assert n2.attributes["shape"] == [1, 2, 5]
...
def test_chunk_large_tensors_pass_real():
    """Tests the test chunk large tensors pass real functionality."""
    g = Graph("mock")
    t = Tensor("large", (10, 100), DType.FLOAT32)
    g.add_tensor(t)
    n = Node("Relu", ["large"], ["out"], {}, "r1")
