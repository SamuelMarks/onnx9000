...
export function initMlirLoweringDemo(): void {
  ...
  const stages = [
    { title: '1. ONNX to MHLO (High-Level Dialect)', code: 'func.func @main() {}' },
    { title: '2. MHLO to Linalg (Structural Dialect)', code: 'linalg.generic' },
    { title: '3. Bufferization (Value -> Memory Semantics)', code: 'memref.alloc' },
    { title: '4. Linalg to HAL & VM (Bytecode Generation)', code: 'hal.command_buffer' },
