...
describe('initOnnx2cUI', () => {
  beforeEach(() => {
    document.body.innerHTML = '<div id="monaco-root"></div><div id="dropzone"></div><input type="file" id="file-input" /><button id="btn-compile"></button><button id="btn-download"></button><select id="target-board"><option value="1000">1000</option></select><select id="target-arch"><option value="c">c</option></select><input type="checkbox" id="opt-cpp" /><input type="checkbox" id="opt-math" /><input type="checkbox" id="opt-unroll" /><div id="controls"></div><div class="tab" data-target="header">Header</div><div class="tab" data-target="source">Source</div>';
    vi.clearAllMocks();
  });
