...
describe('CLI Commands Batch 1', () => {
  ...
  it('handleAgentCommand coverage', () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('my_task'));
  });
  ...
  it('handleAppleCommand coverage', () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('model.onnx'));
  ...
  it('handleAutogradCommand coverage', () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('model_bw.onnx'));
    handleAutogradCommand(['model.onnx', '-o', 'out.onnx']);
    expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('out.onnx'));
