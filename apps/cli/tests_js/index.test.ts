...
vi.mock('../src/commands/convert.js', () => ({ handleConvertCommand: vi.fn() }));
vi.mock('../src/commands/inspect.js', () => ({ handleInspectCommand: vi.fn() }));
vi.mock('../src/commands/json-extract.js', () => ({ handleJsonExtractCommand: vi.fn() }));
vi.mock('../src/commands/pytorch-codegen.js', () => ({ handlePytorchCodegenCommand: vi.fn() }));
vi.mock('../src/commands/whisper-llm.js', () => ({ handleWhisperLlmCommand: vi.fn() }));
vi.mock('../src/commands/llama-web.js', () => ({ handleLlamaWebCommand: vi.fn() }));
vi.mock('../src/commands/tfjs-shim.js', () => ({ handleTfjsShimCommand: vi.fn() }));
...
vi.mock('../src/commands/tensorrt.js', () => ({ handleTensorRTCommand: vi.fn() }));
vi.mock('../src/commands/diffusers.js', () => ({ handleDiffusersCommand: vi.fn() }));
...
vi.mock('../src/commands/transformers.js', () => ({ handleTransformersCommand: vi.fn() }));
vi.mock('../src/commands/coreml.js', () => ({ handleCoreMLCommand: vi.fn() }));
vi.mock('../src/commands/edit.js', () => ({ handleEditCommand: vi.fn() }));
vi.mock('../src/commands/autograd.js', () => ({ handleAutogradCommand: vi.fn() }));
vi.mock('../src/commands/zoo.js', () => ({ handleZooCommand: vi.fn() }));
vi.mock('../src/commands/hummingbird.js', () => ({ handleHummingbirdCommand: vi.fn() }));
vi.mock('../src/commands/sparse.js', () => ({ handleSparseCommand: vi.fn() }));
vi.mock('../src/commands/optimum.js', () => ({ handleOptimumCommand: vi.fn() }));
vi.mock('../src/commands/sphinx-demo-ui.js', () => ({ handleSphinxDemoUICommand: vi.fn() }));
vi.mock('../src/commands/export.js', () => ({ handleExportCommand: vi.fn() }));
vi.mock('../src/commands/onnx2tf.js', () => ({ handleOnnx2TfCommand: vi.fn() }));
vi.mock('../src/commands/optimize.js', () => ({ handleOptimizeCommand: vi.fn() }));
vi.mock('../src/commands/simplify.js', () => ({ handleSimplifyCommand: vi.fn() }));
...
vi.mock('../src/commands/webnn-polyfill.js', () => ({ handleWebnnPolyfillCommand: vi.fn() }));
vi.mock('../src/commands/onnx-checker.js', () => ({ handleOnnxCheckerCommand: vi.fn() }));
vi.mock('../src/commands/script.js', () => ({ handleScriptCommand: vi.fn() }));
vi.mock('../src/commands/mlir.js', () => ({ handleMlirCommand: vi.fn() }));
vi.mock('../src/commands/mobile-memory.js', () => ({ handleMobileMemoryCommand: vi.fn() }));
...
vi.mock('../src/commands/new-model-arch.js', () => ({ handleNewModelArchCommand: vi.fn() }));
vi.mock('../src/commands/zero-dep-classifier.js', () => ({
  handleZeroDepClassifierCommand: vi.fn(),
}));
vi.mock('../src/commands/paddle2onnx.js', () => ({ handlePaddle2ONNX: vi.fn() }));
...
describe('CLI Index', () => {
  ...
  const commands = [
    ...
    { name: 'pytorch-codegen', mock: mockPytorchCodegen.handlePytorchCodegenCommand },
    ...
    { name: 'sphinx-demo-ui', mock: mockSphinxDemoUi.handleSphinxDemoUICommand },
    ...
    { name: 'webnn-polyfill', mock: mockWebnnPolyfill.handleWebnnPolyfillCommand },
    ...
    { name: 'progressive-loading', mock: mockProgressiveLoading.handleProgressiveLoadingCommand },
    { name: 'tflite', mock: mockTflite.handleTfliteCommand },
    { name: 'new-model-arch', mock: mockNewModelArch.handleNewModelArchCommand },
    { name: 'zero-dep-classifier', mock: mockZeroDepClassifier.handleZeroDepClassifierCommand },
