...
def test_coverage_gaps_cmd122():
    ...
    with (
        ...
        with patch.dict(
            ...
            # Misses 353-354 (if os.path.exists(params_path): with open...)
            with (
                patch("builtins.open"),
                patch("os.path.isdir", return_value=True),
                patch("os.path.exists", side_effect=[False, True, True, True, True, True]),
            ...
            # Misses 658, 661-663 (jit stuff)
            # handled via the commands
