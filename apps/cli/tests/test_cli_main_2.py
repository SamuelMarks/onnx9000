    ...
    with patch("onnx9000.core.parser.core.load") as mock_load:
        ...
        with patch("onnx9000.openvino.exporter.OpenVinoExporter") as mock_exp_class:
            ...
            with patch("builtins.open") as mock_open:
                ...
                setattr(args, "data_type", None)
                setattr(args, "shape", ["input_1:1,3,invalid,224", "input_1:1,3,224,224"])
                ...
                setattr(args2, "data_type", ["input_1:float16"])
                setattr(args2, "shape", None)
