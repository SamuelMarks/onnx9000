...
def test_coverage_gaps_cmd58():
    cmds = [
        ...
        ["convert", "test.onnx", "--from", "keras", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "jax", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "paddle", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "sklearn", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "safetensors", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "caffe", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "lightgbm", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "xgboost", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "libsvm", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "h2o", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "sparkml", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "coreml", "--to", "onnx"],
        ["convert", "test.onnx", "--from", "pytorch", "--to", "onnx"],
