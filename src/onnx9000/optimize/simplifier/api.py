...
from onnx9000.optimize.simplifier.passes.constant_folding import constant_folding
from onnx9000.optimize.simplifier.passes.dce import dead_code_elimination
from onnx9000.optimize.simplifier.passes.fusion import run_all_fusions
from onnx9000.optimize.simplifier.passes.shapes import resolve_dynamic_batch
...
def simplify(
    ...
    """
    if dry_run:
        # A full deepcopy might be needed in a real scenario
        import copy
    ...
    logger.info(
        f"Simplification complete. Nodes reduced from {initial_nodes} to {final_nodes}."
    )
