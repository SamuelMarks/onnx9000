...
from onnx9000.frontends.jit.compiler import compile_cpp, compile_wasm, load_module
from onnx9000.frontends.jit.hasher import hash_graph
from onnx9000.frontends.jit.wrapper import CompiledModel
from onnx9000.core.parser import load
...
def compile(
    ...
    if target != "cpp":
        raise NotImplementedError(f"Target {target} not supported yet.")
    ...
    # We must provide the initializers (weights) to the constructor
    init_arrays = []
