...
from onnx9000.frontends.tf.parsers import TFNode, TFGraph


class TFToONNXGraphBuilder:
    """Represents the TFToONNXGraphBuilder class."""

    def __init__(self, name: str = "tf_to_onnx"):
    ...
    def infer_shape(
        self, node: TFNode, input_shapes: List[Tuple[int, ...]]
    ) -> Tuple[int, ...]:
