...
def generate_matmul(node: Node, generator_context: Generator) -> str:
    """Provides generate matmul functionality and verification."""
...
def generate_gemm(node: Node, generator_context: Generator) -> str:
    """Provides generate gemm functionality and verification."""
    inp1 = generator_context.get_tensor_name(node.inputs[0])
    inp2 = generator_context.get_tensor_name(node.inputs[1])
