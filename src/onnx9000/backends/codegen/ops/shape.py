...
def generate_reshape(node: Node, ctx: Generator) -> str:
    """Provides generate reshape functionality and verification."""
...
def generate_flatten(node: Node, ctx: Generator) -> str:
    """Provides generate flatten functionality and verification."""
...
def generate_squeeze(node: Node, ctx: Generator) -> str:
    """Provides generate squeeze functionality and verification."""
...
def generate_unsqueeze(node: Node, ctx: Generator) -> str:
    """Provides generate unsqueeze functionality and verification."""
...
def generate_cast_like(node: Node, ctx: Generator) -> str:
    """Provides generate cast like functionality and verification."""
    inp = ctx.get_tensor_name(node.inputs[0])
    # Target tensor dtype
...
def generate_cast(node: Node, ctx: Generator) -> str:
    """Provides generate cast functionality and verification."""
