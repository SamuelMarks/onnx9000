...
describe("Sanitization utilities", () => {
  it("Removes null terminators from metadata strings", () => {
    ...
    expect(sanitizeMetadataString("multiple\0null\0\0terminators")).toBe(
      "multiplenullterminators",
    );
  });
  ...
  it("Sanitizes filenames by replacing illegal characters with underscores", () => {
    ...
    expect(sanitizeFilename("my/weird\\file:name.bin")).toBe(
      "my_weird_file_name.bin",
    );
