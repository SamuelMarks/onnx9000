    ...
    if (tensor.format === "CSR") {
      ...
      return {
        values: this.device.createBuffer({
          size: tensor.values.byteLength,
          usage: 128,
        }),
        rowPtr: this.device.createBuffer({
          size: tensor.row_ptr.byteLength,
          usage: 128,
        }),
        indices: this.device.createBuffer({
          size: tensor.col_indices.byteLength,
          usage: 128,
        }),
      };
    }
