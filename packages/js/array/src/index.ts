import { Tensor as CoreTensor, type DType, type Shape } from "@onnx9000/core";
...
export class EagerTensor extends BaseTensor {
   ...
   */
  constructor(
    data: ArrayBufferView | number[] | null,
    dtype: DType = "float32",
  ) {
    super(
      "eager",
      [
        Array.isArray(data)
          ? data.length
          : (data as ReturnType<typeof JSON.parse>)?.length || 0,
      ],
      dtype,
    );
 ...
 */
export function Input(_name: string, _shape: Shape, dtype: DType): LazyTensor {
...
export function absolute(
  a: BaseTensor | number,
  ...args: (BaseTensor | number)[]
): BaseTensor {
  if (IS_LAZY)
    return new LazyTensor("Abs", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function negative(
  ...
  if (IS_LAZY)
    return new LazyTensor("Neg", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function sign(
  ...
  if (IS_LAZY)
    return new LazyTensor("Sign", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function exp(
  ...
  if (IS_LAZY)
    return new LazyTensor("Exp", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function log(
  ...
  if (IS_LAZY)
    return new LazyTensor("Log", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function sqrt(
  ...
  if (IS_LAZY)
    return new LazyTensor("Sqrt", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function sin(
  ...
  if (IS_LAZY)
    return new LazyTensor("Sin", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function cos(
  ...
  if (IS_LAZY)
    return new LazyTensor("Cos", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function tan(
  ...
  if (IS_LAZY)
    return new LazyTensor("Tan", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}

/** Functional arcsin */
export function arcsin(
  a: BaseTensor | number,
  ...args: (BaseTensor | number)[]
): BaseTensor {
  if (IS_LAZY)
    return new LazyTensor("Asin", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function arccos(
  ...
  if (IS_LAZY)
    return new LazyTensor("Acos", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function arctan(
  ...
  if (IS_LAZY)
    return new LazyTensor("Atan", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function sinh(
  ...
  if (IS_LAZY)
    return new LazyTensor("Sinh", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function cosh(
  ...
  if (IS_LAZY)
    return new LazyTensor("Cosh", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function tanh(
  ...
  if (IS_LAZY)
    return new LazyTensor("Tanh", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}

/** Functional arcsinh */
export function arcsinh(
  a: BaseTensor | number,
  ...args: (BaseTensor | number)[]
): BaseTensor {
  if (IS_LAZY)
...
export function logical_not(
  a: BaseTensor | number,
  ...args: (BaseTensor | number)[]
): BaseTensor {
  if (IS_LAZY)
    return new LazyTensor("Not", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function tile(
  ...
  if (IS_LAZY)
    return new LazyTensor("Tile", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function pad(
  ...
  if (IS_LAZY)
    return new LazyTensor("Pad", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export function sort(
  ...
  if (IS_LAZY)
    return new LazyTensor("Sort", [a as BaseTensor, ...(args as BaseTensor[])]);
  return new EagerTensor([1.0]);
}
...
export const nn = {
  ...
  sigmoid: (x: BaseTensor | number): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Sigmoid", [x as BaseTensor])
  ...
  conv2d: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Conv", args as BaseTensor[])
      : new EagerTensor(null),
  /** 2D Max Pooling operation. */
  max_pool2d: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("MaxPool", args as BaseTensor[])
      : new EagerTensor(null),
  /** 2D Average Pooling operation. */
  avg_pool2d: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("AveragePool", args as BaseTensor[])
      : new EagerTensor(null),
  /** Batch Normalization operation. */
  batch_norm: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("BatchNormalization", args as BaseTensor[])
      : new EagerTensor(null),
  /** Layer Normalization operation. */
  layer_norm: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("LayerNormalization", args as BaseTensor[])
      : new EagerTensor(null),
  /** Dropout operation. */
  dropout: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Dropout", args as BaseTensor[])
      : new EagerTensor(null),
  /** Linear (Fully Connected) operation. */
  linear: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("MatMul", args as BaseTensor[])
      : new EagerTensor(null),
...
export const linalg = {
  ...
  norm: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("LpNormalization", args as BaseTensor[])
      : new EagerTensor(null),
  /** Matrix determinant. */
  det: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Det", args as BaseTensor[])
      : new EagerTensor(null),
  /** Matrix inverse. */
  inv: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Inv", args as BaseTensor[])
      : new EagerTensor(null),
  /** Solve linear equations. */
  solve: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Solve", args as BaseTensor[])
      : new EagerTensor(null),
  /** Singular Value Decomposition. */
  svd: (...args: (BaseTensor | number)[]): BaseTensor =>
    IS_LAZY
      ? new LazyTensor("Svd", args as BaseTensor[])
      : new EagerTensor(null),
};
