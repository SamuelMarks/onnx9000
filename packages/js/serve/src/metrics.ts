...
export class PrometheusMetrics {
  ...
  public generateTextFormat(): string {
    ...
    out +=
      "# HELP onnx9000_inference_request_total Total number of inference requests\n";
    out += "# TYPE onnx9000_inference_request_total counter\n";
    out += `onnx9000_inference_request_total ${this.requestTotal}\n\n`;

    out +=
      "# HELP onnx9000_active_requests Number of currently active inference requests\n";
    ...
    out +=
      "# HELP onnx9000_inference_request_duration_seconds Total sum of inference duration\n";
    ...
    out +=
      "# HELP onnx9000_inference_queue_duration_seconds Total sum of queue duration\n";
