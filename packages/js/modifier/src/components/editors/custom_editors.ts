...
function renderCastEditor(
  ...
  select.addEventListener(
    "change",
    function (e: ReturnType<typeof JSON.parse>) {
...
function renderScatterNDEditor(
  container: HTMLElement,
  node: Node,
  mutator: GraphMutator,
) {
