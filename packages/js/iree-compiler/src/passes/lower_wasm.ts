...
import { Block, Operation, Region } from "../ir/core.js";
...
// 95. Loop unrolling
export function unrollLoops(_region: Region): void {
  // Stub
}

// 96. Vectorization pass
export function vectorizeLoops(_region: Region): void {
  // Stub
}
...
export class WASMEmitter {
  ...
  compileWATToWASM(_wat: string): Uint8Array {
