...
describe("Keras Phase 9 - Quantization-Aware Training & Dynamic Quantization", () => {
      ...
      modelTopology: {
        ...
        config: {
          layers: [
            ...
            {
              class_name: "Dense",
              config: { name: "quantize_wrapper_dense1", units: 10 },
            },
          ],
        },
      },
  ...
  it("should map 4-bit packed weights and dynamic_quant to MatMulNBits and DynamicQuantizeLinear", () => {
      ...
      modelTopology: {
        ...
        config: {
          layers: [
            ...
            {
              class_name: "Dense",
              config: { name: "packed_4bit_dense", units: 10 },
            },
            {
              class_name: "Dense",
              config: { name: "dynamic_quant_dense", units: 10 },
            },
          ],
        },
      },
    ...
    const dqlNode = finalNodes.find(
      (n) => n.opType === "DynamicQuantizeLinear",
    );
