...
describe("SavedModel Parser", () => {
  it("throws on missing saved_model.pb", () => {
    expect(() =>
      parseSavedModel({ "variables.index": new Uint8Array() }),
    ).toThrow("Invalid SavedModel format: missing saved_model.pb");
  });
  ...
  it("parses correctly", () => {
    const files = {
      ...
      "my_model/variables/variables.data-00000-of-00001": new Uint8Array([
        6, 7,
      ]),
      "my_model/variables/variables.data-00001-of-00001": new Uint8Array([
        8, 9,
      ]),
    };
