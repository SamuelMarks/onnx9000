...
import { emitActivation, emitDense, emitIdentity, type OnnxNodeBuilder } from './emitters.js';
import { emitConv } from './emitters-conv.js';
import { emitGlobalPool, emitPool } from './emitters-pool.js';
import { extractKerasTopology, type KerasModelTopology, type KerasNodeSpec } from './keras-ast.js';
import { LayoutOptimizer, type OnnxNodeLike } from './layout-optimizer.js';
import { KerasGraphOptimizer } from './optimizers.js';
import { getCustomKerasLayerEmitter } from './plugin-registry.js';
import { type JsonObject, parseTFJSModel } from './tfjs-parser.js';
...
export class Keras2OnnxConverter {
  ...
  public convert(): Uint8Array {
    ...
    for (const inp of inputs) {
      ...
      if (this.topology.signatures?.serving_default) {
