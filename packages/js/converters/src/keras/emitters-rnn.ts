...
export function emitBidirectional(
  ...
  _backwardWName: string,
  _backwardRName: string,
  _backwardBName: string | undefined,
  ...
  const _mergeOut = `${name}_merged`;
  const seqOrStateOut = options.returnSequences ? yOut : yhOut;
