...
) => any[]; // Returns an array of raw OnnxNodeBuilder-like objects to be pushed to rawNodes
 ...
 */
export function registerCustomKerasLayer(kerasLayerName: string, emitter: CustomLayerEmitter): void {
