...
export class AbsOp implements OpImplementation {
  ...
  execute(
    ...
    return [
      new Tensor(`${x.name}_abs`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AddOp implements OpImplementation {
  ...
  execute(
    ...
    return [
      new Tensor(`${a.name}_add`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class ReluOp implements OpImplementation {
  ...
  execute(
    ...
    return [
      new Tensor(`${x.name}_relu`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class SubOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_sub`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class MulOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_mul`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class DivOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_div`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class PowOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_pow`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class ModOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_mod`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class FmodOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_fmod`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class SignOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_sign`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class NegOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_neg`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class ExpOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_exp`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class LogOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_log`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class Log2Op implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_log2`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class Log10Op implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_log10`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class Expm1Op implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_expm1`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class Log1pOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_log1p`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class SinOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_sin`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class CosOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_cos`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class TanOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_tan`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AsinOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_asin`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AcosOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_acos`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AtanOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_atan`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class SinhOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_sinh`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class CoshOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_cosh`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AsinhOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_asinh`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AcoshOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_acosh`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class AtanhOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_atanh`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class ErfOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_erf`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class IsNaNOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_isnan`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class IsInfOp implements OpImplementation {
  execute(
    ...
    for (let i = 0; i < view.length; i++) {
      newData[i] = ((val) =>
        !Number.isFinite(val ?? 0) && !Number.isNaN(val ?? 0) ? 1 : 0)(view[i]);
    }
    return [
      new Tensor(`${x.name}_isinf`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class IsFiniteOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${x.name}_isfinite`, x.shape, x.dtype, false, true, newData),
    ];
  }
}
...
export class BitwiseOrOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_bitwiseor`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class BitShiftOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_bitshift`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class LogicalOrOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_logicalor`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class EqualOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_equal`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class GreaterOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_greater`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class LessOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_less`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class MaxOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_max`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class MinOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(`${a.name}_min`, a.shape, a.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceMinOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducemin`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceSumOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducesum`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceMeanOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducemean`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceProdOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reduceprod`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceL1Op implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducel1`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceL2Op implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducel2`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ReduceLogSumOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_reducelogsum`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class CastLikeOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array(1);
    return [
      new Tensor(`${x.name}_castlike`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class UnsqueezeOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_unsqueeze`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class TransposeOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_transpose`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class GatherElementsOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_gatherelements`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class GatherNDOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_gathernd`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class ScatterNDOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_scatternd`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class SpaceToDepthOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_spacetodepth`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class DepthToSpaceOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_depthtospace`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class MaxPool1DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_maxpool1d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class MaxPool2DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_maxpool2d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class MaxPool3DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_maxpool3d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class AveragePool1DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_averagepool1d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class AveragePool2DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_averagepool2d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class AveragePool3DOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_averagepool3d`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class BatchNormOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_batchnorm`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class LayerNormOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_layernorm`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class GroupNormOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_groupnorm`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class InstanceNormOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_instancenorm`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class LeakyReluOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_leakyrelu`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class HardSigmoidOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_hardsigmoid`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class SoftsignOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_softsign`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class SoftplusOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_softplus`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class HardSwishOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_hardswish`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class FlashAttentionOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_flashattention`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class PagedAttentionOp implements OpImplementation {
  execute(
    ...
    const newData = new Float32Array([0]);
    return [
      new Tensor(`${x.name}_pagedattention`, [], x.dtype, false, true, newData),
    ];
  }
}
...
export class SlidingWindowAttentionOp implements OpImplementation {
  execute(
    ...
    return [
      new Tensor(
        `${x.name}_slidingwindowattention`,
        [],
        x.dtype,
        false,
        true,
