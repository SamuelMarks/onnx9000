...
@patch("onnx9000.converters.jit.compiler.config")
@patch("onnx9000.converters.jit.compiler.sys")
@patch("onnx9000.converters.jit.compiler.shutil")
@patch("onnx9000.converters.jit.compiler.PackageLoader")
...
@patch("onnx9000.converters.jit.compiler.subprocess.run")
@patch("onnx9000.converters.jit.compiler._get_compiler", return_value="g++")
@patch("onnx9000.converters.jit.compiler.PackageLoader")
def test_compile_cpp_compile_success(
    ...
    with patch("onnx9000.converters.jit.compiler.Generator") as mock_gen:
        mock_gen.return_value.generate.return_value = "code"
        with patch("onnx9000.converters.jit.compiler.Environment") as mock_env:
...
@patch("onnx9000.converters.jit.compiler.shutil.which", return_value=None)
@patch("onnx9000.converters.jit.compiler.PackageLoader")
...
@patch("onnx9000.converters.jit.compiler.subprocess.run")
@patch("onnx9000.converters.jit.compiler.shutil.which", return_value="emcc")
@patch("onnx9000.converters.jit.compiler.PackageLoader")
