...
def test_exporter_gaps():
    ...
    try:
        ...
        exporter.add_buffer(b"test_buffer")  # hit dedup
        exporter.add_buffer(
            b"bytearray"
        )  # hit bytearray hash issue natively? Wait I fixed it in exporter.py or subgraph.py? I cast to bytes in subgraph.py. Let's just pass bytes.
