...
class nn:
    ...
    @staticmethod
    def relu(x: Any) -> Any:
        return LazyTensor("Relu", [x]) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def sigmoid(x: Any) -> Any:
        return LazyTensor("Sigmoid", [x]) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def softmax(x: Any, axis: Any = -1) -> Any:
        return LazyTensor("Softmax", [x, axis]) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def log_softmax(x: Any, axis: Any = -1) -> Any:
        return LazyTensor("LogSoftmax", [x, axis]) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def gelu(x: Any) -> Any:
        return LazyTensor("Gelu", [x]) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def conv2d(*args: Any) -> Any:
        return LazyTensor("Conv", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def max_pool2d(*args: Any) -> Any:
        return LazyTensor("MaxPool", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def avg_pool2d(*args: Any) -> Any:
        return LazyTensor("AveragePool", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def batch_norm(*args: Any) -> Any:
        return LazyTensor("BatchNormalization", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def layer_norm(*args: Any) -> Any:
        return LazyTensor("LayerNormalization", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def dropout(*args: Any) -> Any:
        return LazyTensor("Dropout", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def linear(*args: Any) -> Any:
        return LazyTensor("MatMul", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def cross_entropy_loss(*args: Any) -> Any:
        return LazyTensor("SoftmaxCrossEntropyLoss", list(args)) if IS_LAZY else EagerTensor(None)
...
class linalg:
    ...
    def norm(*args: Any) -> Any:
        return LazyTensor("LpNormalization", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def det(*args: Any) -> Any:
        return LazyTensor("Det", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def inv(*args: Any) -> Any:
        return LazyTensor("Inv", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def solve(*args: Any) -> Any:
        return LazyTensor("Solve", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def svd(*args: Any) -> Any:
        return LazyTensor("Svd", list(args)) if IS_LAZY else EagerTensor(None)
...
class char:
    ...
    def add(*args: Any) -> Any:
        return LazyTensor("StringConcat", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def equal(*args: Any) -> Any:
        return LazyTensor("StringEqual", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def replace(*args: Any) -> Any:
        return LazyTensor("StringReplace", list(args)) if IS_LAZY else EagerTensor(None)
...
class random:
    ...
    def rand(*args: Any) -> Any:
        return LazyTensor("RandomUniform", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def randn(*args: Any) -> Any:
        return LazyTensor("RandomNormal", list(args)) if IS_LAZY else EagerTensor(None)

    @staticmethod
    def randint(*args: Any) -> Any:
        return LazyTensor("RandomUniformInt", list(args)) if IS_LAZY else EagerTensor(None)
