...
def test_cuda_executor_fallback() -> None:
    ...
    with (
        ...
        patch("onnx9000.backends.cuda.cuda_arena.is_cuda_available", return_value=False),
    ):
...
def test_cuda_executor_matmul_cublas() -> None:
    ...
    with (
        ...
        patch("onnx9000.backends.cuda.cuda_arena.is_cuda_available", return_value=True),
        ...
        patch(
            "onnx9000.backends.cuda.cuda_arena._cuda_lib",
            MagicMock(
                **{
        ...
        with patch(
            ...
            with patch(
                "onnx9000.backends.cuda.cuda_arena.CUDAMemoryPlanner.get_host_tensor",
