...
def test_validate_training_graph() -> None:
    """Tests the test validate training graph functionality."""
    from onnx9000.core.ir import Graph
    from onnx9000.toolkit.training.autograd.compiler import validate_training_graph
...
def test_custom_loss_and_ort_validation() -> None:
    """Tests the test custom loss and ort validation functionality."""
    from onnx9000.core.ir import Graph
    from onnx9000.toolkit.training.autograd.compiler import inject_custom_loss_subgraph
