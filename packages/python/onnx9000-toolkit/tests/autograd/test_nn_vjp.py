...
def test_gemm_vjp() -> None:
    """Tests the test_gemm_vjp functionality."""
...
def test_convtranspose_vjp() -> None:
    """Tests the test_convtranspose_vjp functionality."""
...
def test_globalavgpool_vjp() -> None:
    """Tests the test_globalavgpool_vjp functionality."""
...
def test_globalmaxpool_vjp() -> None:
    """Tests the test_globalmaxpool_vjp functionality."""
...
def test_layernorm_vjp() -> None:
    """Tests the test_layernorm_vjp functionality."""
...
def test_instancenorm_vjp() -> None:
    """Tests the test_instancenorm_vjp functionality."""
...
def test_dropout_vjp() -> None:
    """Tests the test_dropout_vjp functionality."""
