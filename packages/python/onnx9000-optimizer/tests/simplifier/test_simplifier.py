...
def test_fuse_consecutive_transpose() -> None:
...
def test_constant_folding_add() -> None:
...
def test_constant_folding_partial_identity() -> None:
...
def test_constant_folding_reshape() -> None:
...
def test_constant_folding_mul() -> None:
...
def test_constant_folding_slice() -> None:
...
def test_identity_elimination_concat() -> None:
...
def test_identity_elimination_cast() -> None:
