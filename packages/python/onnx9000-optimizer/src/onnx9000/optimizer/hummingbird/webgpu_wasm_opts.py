...
class WebGPUWASMCompilerOpts:
    ...
    def __init__(self, max_buffer_size: int = 128 * 1024 * 1024):
        self.max_buffer_size = max_buffer_size
        self.max_texture_dim = 8192

    def eliminate_branch_divergence(self, g: Graph):
    ...
    def optimize_topology_for_ort_web(self, g: Graph):
