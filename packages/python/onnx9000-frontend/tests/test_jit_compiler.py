...
from onnx9000.frontend.jit.compiler import _get_compiler, compile_cpp, compile_wasm, load_module
...
@patch("onnx9000.frontend.jit.compiler.hash_graph", return_value="test_hash")
@patch("onnx9000.frontend.jit.compiler.Generator")
@patch("onnx9000.frontend.jit.compiler.Environment")
@patch("onnx9000.frontend.jit.compiler.PackageLoader")
@patch("onnx9000.frontend.jit.compiler.open")
...
def test_compile_cpp(
    ...
    with (
        ...
        patch("onnx9000.frontend.jit.compiler._get_compiler", return_value="clang++"),
    ):
...
@patch("onnx9000.frontend.jit.compiler.hash_graph", return_value="test_wasm_hash")
@patch("onnx9000.frontend.jit.compiler.Generator")
@patch("onnx9000.frontend.jit.compiler.Environment")
@patch("onnx9000.frontend.jit.compiler.PackageLoader")
@patch("onnx9000.frontend.jit.compiler.open")
