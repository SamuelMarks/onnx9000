...
from onnx9000.frontend.jit.wrapper import CompiledModel


@patch("onnx9000.frontend.jit.load")
@patch("onnx9000.frontend.jit.plan_memory")
@patch("onnx9000.frontend.jit.compile_wasm")
...
@patch("onnx9000.frontend.jit.load")
@patch("onnx9000.frontend.jit.plan_memory")
@patch("onnx9000.frontend.jit.compile_cpp")
@patch("onnx9000.frontend.jit.load_module")
@patch("onnx9000.frontend.jit.hash_graph")
