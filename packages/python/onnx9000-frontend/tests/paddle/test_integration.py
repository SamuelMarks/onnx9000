import time
import pytest
from onnx9000.frontend.paddle.api import convert_paddle_to_onnx
from onnx9000.frontend.paddle.parsers import PaddleBlock, PaddleGraph, PaddleNode


def test_integration_paddle_linear_regression() -> None:
    from onnx9000.frontend.paddle.api import _convert_paddle_graph
    from onnx9000.frontend.paddle.parsers import PaddleBlock, PaddleGraph, PaddleNode
