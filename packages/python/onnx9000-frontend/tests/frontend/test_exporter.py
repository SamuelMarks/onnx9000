...
from onnx9000.frontend.frontend.exporter import export
...
def test_export_large_model(tmp_path) -> None:
    ...
    with patch("onnx9000.frontend.frontend.exporter.build_model_proto") as mock_build:
...
def test_exporter_visualize() -> None:
    ...
    from onnx9000.frontend.frontend.exporter import visualize
