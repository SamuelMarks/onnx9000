...
from onnx9000.frontend.frontend.nn.conv import (
    Conv1d,
    Conv2d,
    Conv3d,
    ConvTranspose1d,
...
from onnx9000.frontend.frontend.nn.dropout import Dropout, Dropout2d, Dropout3d
...
from onnx9000.frontend.frontend.nn.functional import (
    conv2d,
    gelu,
    interpolate,
    linear,
...
from onnx9000.frontend.frontend.nn.identity import Identity
from onnx9000.frontend.frontend.nn.linear import Linear
from onnx9000.frontend.frontend.nn.normalization import (
    BatchNorm1d,
    BatchNorm2d,
    BatchNorm3d,
    GroupNorm,
...
from onnx9000.frontend.frontend.nn.pool import (
    AdaptiveAvgPool2d,
    AvgPool1d,
    AvgPool2d,
    MaxPool1d,
...
from onnx9000.frontend.frontend.nn.rnn import GRU, LSTM, RNN
...
def test_functional_kwargs() -> None:
    ...
    with Tracing(gb):
        t = Tensor((1, 3, 10, 10), DType.FLOAT32)
        from onnx9000.frontend.frontend.nn.functional import interpolate, pad
...
def test_functional_missing_coverage() -> None:
    ...
    with Tracing(gb):
        ...
        from onnx9000.frontend.frontend.nn.functional import conv2d, linear
...
def test_rnn_list_return() -> None:
    ...
    with Tracing(gb):
        ...
        with patch("onnx9000.frontend.frontend.utils.record_op", fake_rec):
            d = Dropout(0.5)
