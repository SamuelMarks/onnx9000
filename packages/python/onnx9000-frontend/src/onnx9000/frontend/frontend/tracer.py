...
from onnx9000.frontend.frontend.builder import GraphBuilder, get_active_builder
...
class Tracer:
    ...
    def __enter__(self) -> GraphBuilder:
        ...
        import onnx9000.frontend.frontend.builder as builder_mod
...
def script(func: Callable, *args: Any, **kwargs: Any) -> GraphBuilder:
    ...
    from onnx9000.frontend.frontend.ast_parser import ScriptCompiler
